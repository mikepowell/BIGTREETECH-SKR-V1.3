...
// *** Finder uses Xmax, Ymax, and Zmax
...
// *** Signals from the Finder endstop circuits is +5V in "open" state and 0V in "triggered" state
// *** (opposite of what's described above)
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 94.1, 94.1, 400, 153.8 }
...
// *** On the finder, all stops are in the MAX direction.
// :[-1,1]
#define X_HOME_DIR 1
#define Y_HOME_DIR 1
#define Z_HOME_DIR 1
